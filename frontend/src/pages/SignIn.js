    ...
    <div className="auth-page">
      <div className="auth-left">
        ...
        <div className="auth-left-content">
          <h2 className="auth-left-title">Good to have<br /><em>you back.</em></h2>
          <p className="auth-left-sub">Your curated selection awaits.</p>
        </div>
      ...
      <div className="auth-right">
        <div className="auth-form-wrap fade-up">
          ...
          <p className="auth-subtitle">New here? <Link to="/signup" className="auth-link">Create account</Link></p>
